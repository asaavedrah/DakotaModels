(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@ngx-loading-bar/core', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,(global['ngx-loading-bar'] = global['ngx-loading-bar'] || {}, global['ngx-loading-bar'].core = {}), global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators));
...
'use strict';
    ...
    ***************************************************************************** */
    ...
    var LoadingBarService = /** @class */ (function () {
        ...
        LoadingBarService = __decorate([ __param(0, core.Inject(core.PLATFORM_ID)),
            __param(1, core.Optional()), __param(1, core.Inject(LOADING_BAR_CONFIG)),
            __metadata("design:paramtypes", [Object, Object])
        ], LoadingBarService);
LoadingBarService.ɵfac = function LoadingBarService_Factory(t) { return new (t || LoadingBarService)(ɵngcc0.ɵɵinject(core.PLATFORM_ID), ɵngcc0.ɵɵinject(LOADING_BAR_CONFIG, 8)); };
...
LoadingBarModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LoadingBarModule_Factory(t) { return new (t || LoadingBarModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LoadingBarModule, { declarations: [LoadingBarComponent], imports: [ɵngcc1.CommonModule], exports: [LoadingBarComponent] }); })();
